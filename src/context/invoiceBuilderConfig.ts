...
export const packageTemplates: PackageTemplate[] = [
  {
    ...
    selectedEquipmentBySection: {
      ...
      [SECTION_IDS.LIGHTING_SYSTEM]: [
        ITEM_IDS.LIGHT_BACKLIGHTS_RGB_4,
        ITEM_IDS.LIGHT_DMX_512_CONTROLLER,
  ...
  },
  {
    ...
    selectedEquipmentBySection: {
      ...
      [SECTION_IDS.LIGHTING_SYSTEM]: [
        ...
        ITEM_IDS.LIGHT_DMX_512_CONTROLLER,
        ITEM_IDS.LIGHT_FRONT_LIGHTS_AMBER_8,
        ITEM_IDS.ACCESSORY_T_BAR_STANDS_2,
  ...
  },
  {
    ...
    selectedEquipmentBySection: {
      [SECTION_IDS.AUDIO_SYSTEM]: [
        ITEM_IDS.AUDIO_SPEAKERS_2,
        ITEM_IDS.AUDIO_MIXER_SQ5,
        ITEM_IDS.AUDIO_MONITOR_SPEAKERS_4_QSC_YAMAHA,
        ITEM_IDS.AUDIO_STAGE_BOX_AR2412,
        ITEM_IDS.AUDIO_SUB_2_KLA181,
      ],
      [SECTION_IDS.LIGHTING_SYSTEM]: [
        ITEM_IDS.LIGHT_BACKLIGHTS_RGB_8,
        ITEM_IDS.LIGHT_FRONT_LIGHTS_AMBER_4,
        ITEM_IDS.LIGHT_CONTROLLER_MINIPEARL_1024,
        ITEM_IDS.ACCESSORY_T_BAR_STANDS_4,
      ],
      [SECTION_IDS.MICROPHONE]: [
        ITEM_IDS.MIC_WIRELESS_2,
        ITEM_IDS.MIC_WIRED_2,
      ],
      [SECTION_IDS.OTHERS]: [
        ITEM_IDS.OTHER_SPEAKER_STANDS_2,
        ITEM_IDS.OTHER_XLR_CABLES,
        ...
        ITEM_IDS.OTHER_EXTENSION_CABLES,
        ITEM_IDS.OTHER_AUX_CABLE,
        ITEM_IDS.OTHER_MIC_STANDS_3,
        ITEM_IDS.OTHER_LYRIC_STAND_1,
        ITEM_IDS.OTHER_FOG_MACHINE_1,
      ],
      [SECTION_IDS.CREW_AND_TRANSPORT]: [
        ITEM_IDS.CREW_TRANSPORT_SERVICE,
        ITEM_IDS.CREW_TECH_5,
      ],
      [SECTION_IDS.DRUMS]: [
        ITEM_IDS.DRUMS_DRUMSET,
        ITEM_IDS.DRUMS_CYMBALS,
        ITEM_IDS.DRUMS_KICK_PEDAL,
        ITEM_IDS.DRUMS_KICK_MIC,
        ITEM_IDS.DRUMS_SNARE_MIC,
        ITEM_IDS.DRUMS_TOM_MICS_2,
        ITEM_IDS.DRUMS_OVERHEAD_MIC_1,
      ],
      [SECTION_IDS.AMPLIFIERS]: [
        ITEM_IDS.AMP_GUITAR_AMPLIFIERS_2,
        ITEM_IDS.AMP_BASS_AMPLIFIER,
        ITEM_IDS.AMP_GUITAR_MICS_2,
      ],
    },
    defaultFormValues: {
  ...
  },
  {
    ...
    selectedEquipmentBySection: {
      [SECTION_IDS.AUDIO_SYSTEM]: [
        ...
        ITEM_IDS.AUDIO_SUBWOOFERS_2_KW181,
        ITEM_IDS.AUDIO_MONITOR_SPEAKERS_2_QSC_K12,
        ITEM_IDS.AUDIO_DELAY_SPEAKERS_2_RCF_915,
        ITEM_IDS.AUDIO_FRONTFILL_SPEAKERS_2_YAMAHA_DXR10,
      ],
      [SECTION_IDS.LIGHTING_SYSTEM]: [
        ITEM_IDS.LIGHT_CONTROLLER_MINIPEARL_1024,
        ITEM_IDS.LIGHT_MOVING_HEADS_SET_4_WITH_TRUSSES,
        ITEM_IDS.LIGHT_MOVING_WASH_2,
        ITEM_IDS.LIGHT_PAR_LIGHTS_16,
        ITEM_IDS.LIGHT_FRONTAL_LIGHTS_8,
        ITEM_IDS.EFFECT_HAZE_MACHINE,
      ],
      [SECTION_IDS.MICROPHONE]: [
        ITEM_IDS.MIC_WIRELESS_4,
        ITEM_IDS.MIC_WIRED_1,
      ],
      [SECTION_IDS.OTHERS]: [
        ITEM_IDS.OTHER_SPEAKER_STANDS_2,
      ...
      [SECTION_IDS.ADD_ONS]: [ITEM_IDS.ADDON_MOVING_HEADLIGHTS_2_MORE],
    },
    defaultFormValues: {
  ...
  },
  {
    ...
    selectedEquipmentBySection: {
      [SECTION_IDS.AUDIO_SYSTEM]: [
        ...
        ITEM_IDS.AUDIO_MONITOR_SPEAKERS_4_QSC_YAMAHA,
        ITEM_IDS.AUDIO_STAGE_BOX_AR2412,
        ITEM_IDS.AUDIO_SUBWOOFERS_4_KLA181,
      ],
      [SECTION_IDS.LIGHTING_SYSTEM]: [
        ITEM_IDS.LIGHT_MOVING_HEADS_SET_4_WITH_TRUSSES,
        ITEM_IDS.LIGHT_MOVING_WASH_2,
        ITEM_IDS.LIGHT_CONTROLLER_MINIPEARL_1024,
        ITEM_IDS.LIGHT_FRONTAL_LIGHTS_8,
        ITEM_IDS.LIGHT_BACKDROP_LIGHTS_16,
        ITEM_IDS.EFFECT_HAZE_MACHINE,
      ],
      [SECTION_IDS.MICROPHONE]: [
        ITEM_IDS.MIC_WIRELESS_4,
      ...
      [SECTION_IDS.OTHERS]: [
        ...
        ITEM_IDS.OTHER_MIC_STANDS_3,
        ITEM_IDS.OTHER_LYRIC_STAND_1,
        ITEM_IDS.OTHER_COMM_SET_6,
        ITEM_IDS.OTHER_LED_WALL_9X12,
        ITEM_IDS.OTHER_STAGE_16X24,
      ],
    },
    defaultFormValues: {
